...
quarter_invratio_layout = dbc.Container([
...
# This is the graph for the PFCF Ratio
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "PFCFRatio-quarter",
            figure = {}
            ),
            width = 9),
...
@app.callback(
    Output(component_id = 'PERatio-quarter', component_property = 'figure'),
    Output(component_id = 'PSRatio-quarter', component_property = 'figure'),
    Output(component_id = 'PBVRatio-quarter', component_property = 'figure'),
    Output(component_id = 'PFCFRatio-quarter', component_property = 'figure'),
    Output(component_id = 'PEGRatio-quarter', component_property = 'figure'),
