...
quarter_liqratio_layout = dbc.Container([
    dbc.Row([
...
# This is the graph for the Current Ratio  
    dbc.Container(style = {'border': "2px black solid"}, children = [
        ...
        dbc.Col(
            dcc.Graph(id = "currentRatio-quarter",
            figure = {}
            ),
            width = 9),
...
# This is the graph for the Quick Ratio  
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "quickRatio-quarter",
            figure = {}
            ),
            width = 9),
...
# This is the graph for the Short Term Coverage Ratio  
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "shortTermCoverageRatio-quarter",
            figure = {}
            ),
            width = 9),
...
# This is the graph for the Debt Ratio
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "debtRatio-quarter",
            figure = {}
            ),
            width = 9),
...
# This is the graph for the Debt-to-Equity Ratio
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "debtEquityRatio-quarter",
            figure = {}
            ),
            width = 9),

        dbc.Col(
            id = "debtEquityRatioDescrip",
            className = "py-5 d-inline-block",
            children = [
            html.H2("Description:\n"),
...
# This is the graph for the Cash Flow Coverage Ratio
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "CFCoverageRatio-quarter",
            figure = {}
            ),
            width = 9),

        dbc.Col(
            id = "CFCoverageRatioDescrip",
            className = "py-5 d-inline-block",
            children = [
            html.H2("Description:\n"),
...
@app.callback(
    Output(component_id = 'currentRatio-quarter', component_property = 'figure'),
    Output(component_id = 'quickRatio-quarter', component_property = 'figure'),
    Output(component_id = 'shortTermCoverageRatio-quarter', component_property = 'figure'),
    Output(component_id = 'debtRatio-quarter', component_property = 'figure'),
    Output(component_id = 'debtEquityRatio-quarter', component_property = 'figure'),
    Output(component_id = 'CFCoverageRatio-quarter', component_property = 'figure'),
