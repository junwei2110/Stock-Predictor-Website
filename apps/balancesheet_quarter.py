...
# This is the data table for the balance sheet, the assets and liabilities graphs 
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "AssetsBarPlot-quarter",
            figure = {},
            style={'height': 450}),
            width = 6),
        
        dbc.Col(
            dcc.Graph(id = "LiabilitiesBarPlot-quarter",
            figure = {},
            style={'height': 450})
            ,
            width = 6)
...
# This is the equity graphs  
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "EquityBarPlot-quarter",
            figure = {}),
            width = 12)
    ]),
...
# This is the liquidity ratios and the solvency ratios graphs  
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "liquidityRatios-quarter",
            figure = {})
            ,
            width = 6),

        dbc.Col(
            dcc.Graph(id = "solvencyRatios-quarter",
            figure = {})
            ,
            width = 6),
...
# This is the current assets breakdown and the long term assets breakdown graphs  
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "currentAssetsBreakdownPlot-quarter",
            figure = {})
            ,
            width = 6),

        dbc.Col(
            dcc.Graph(id = "longtermAssetsBreakdownPlot-quarter",
            figure = {})
            ,
            width = 6),
...
# This is the current liabilities breakdown and the long term liabilities breakdown graph
    ...
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "currentLiabilitiesBreakdownPlot-quarter",
            figure = {})
            ,
            width = 6),

        dbc.Col(
            dcc.Graph(id = "longtermLiabilitiesBreakdownPlot-quarter",
            figure = {})
            ,
            width = 6)
...
@app.callback(
     [Output(component_id = 'balance-table-quarter', component_property = 'columns'),
     Output(component_id = 'balance-table-quarter', component_property = 'data'),
     Output(component_id='AssetsBarPlot-quarter', component_property='figure'),
     Output(component_id='LiabilitiesBarPlot-quarter', component_property='figure'),
     Output(component_id='EquityBarPlot-quarter', component_property='figure'),
     Output(component_id='liquidityRatios-quarter', component_property='figure'),
     Output(component_id='solvencyRatios-quarter', component_property='figure'),
     Output(component_id='currentAssetsBreakdownPlot-quarter', component_property='figure'),
     Output(component_id='longtermAssetsBreakdownPlot-quarter', component_property='figure'),
     Output(component_id='currentLiabilitiesBreakdownPlot-quarter', component_property='figure'),
     Output(component_id='longtermLiabilitiesBreakdownPlot-quarter', component_property='figure')],
...
def figure_callback(period_range, data_quarter, state):
    ...
    balance_dff = pd.read_json(data_quarter)
    ...
    balance_dff = balance_dff.sort_values(by = ["date"])
