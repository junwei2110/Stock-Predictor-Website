...
annual_growratio_layout = dbc.Container([
...
# This is the graph for the Op Profit Growth 
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "OpProfGrowth-annual",
            figure = {}
            ),
            width = 9),
...
# This is the graph for the Assets Growth
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "assetsgrowth-annual",
            figure = {}
            ),
            width = 9),

        dbc.Col(
            id = "assetsgrowthDescrip-annual",
            className = "py-5 d-inline-block",
            children = [
            html.H2("Description:\n"),
...
# This is the graph for the Debt Growth
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "debtgrowth-annual",
            figure = {}
            ),
            width = 9),

        dbc.Col(
            id = "debtgrowthDescrip-annual",
            className = "py-5 d-inline-block",
            children = [
            html.H2("Description:\n"),
...
@app.callback(
    Output(component_id = 'RG-annual', component_property = 'figure'),
    Output(component_id = 'FCFG-annual', component_property = 'figure'),
    Output(component_id = 'OpProfGrowth-annual', component_property = 'figure'),
    Output(component_id = 'assetsgrowth-annual', component_property = 'figure'),
    Output(component_id = 'debtgrowth-annual', component_property = 'figure'),
    Input(component_id='period-slider-annual', component_property='value'),
    Input(component_id = "annual-growthratios-memory", component_property = "data"),
