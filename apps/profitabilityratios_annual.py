...
annual_profratio_layout = dbc.Container([
...
@app.callback(
    Output(component_id = 'ROE-annual', component_property = 'figure'),
    Output(component_id = 'ROA-annual', component_property = 'figure'),
    Output(component_id = 'ROCE-annual', component_property = 'figure'),
    Output(component_id = 'grossProfitMargin-annual', component_property = 'figure'),
    Output(component_id = 'OpProfitMargin-annual', component_property = 'figure'),
    Output(component_id = 'netProfitMargin-annual', component_property = 'figure'),
