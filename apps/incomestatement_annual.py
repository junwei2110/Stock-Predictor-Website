...
annual_income_layout = dbc.Container([
...
# This is the data table, revenue and gross profit graphs 
    ...
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "RevenueBarPlot-annual",
            figure = {},
            ),
            width = 6),
        
        dbc.Col(
            dcc.Graph(id = "GrossProfitBarPlot-annual",
            figure = {},
            ),
            width = 6)
    ]),
...
# This is the opex and Depreciation graphs
    dbc.Row([
        dbc.Col(
            dcc.Graph(id = "OperatingExpBarPlot-annual",
            figure = {}
            ),
            width = 6),

        dbc.Col(
            dcc.Graph(id = "Deprec-AmortBarPlot-annual",
            figure = {}
            ),
            width = 6),
...
# This is the EBITDA & net income graphs
    ...
    dbc.Row([
        ...
        dbc.Col(
            dcc.Graph(id = "EBITDA-OpIncomeBarPlot-annual",
            figure = {}
            ),
            width = 6),   

        dbc.Col(
            dcc.Graph(id = "NetIncome-annual",
            figure = {}
            ),
            width = 6),
...
@app.callback(
     [Output(component_id = 'income-table-annual', component_property = 'columns'),
     Output(component_id = 'income-table-annual', component_property = 'data'),
     Output(component_id='RevenueBarPlot-annual', component_property='figure'),
     Output(component_id='GrossProfitBarPlot-annual', component_property='figure'),
     Output(component_id='OperatingExpBarPlot-annual', component_property='figure'),
     Output(component_id='Deprec-AmortBarPlot-annual', component_property='figure'),
     Output(component_id='EBITDA-OpIncomeBarPlot-annual', component_property='figure'),
     Output(component_id='NetIncome-annual', component_property='figure'),
     Output(component_id='EPS-annual', component_property='figure')],
...
def figure_callback(period_range, data_annual, state):
    ...
    income_dff = pd.read_json(data_annual)
